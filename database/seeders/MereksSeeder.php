...
class MereksSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $booking1 = Booking::create(['id_mobil' => $mobil1->id, 'id_customer' => $customer1->id, 'id_sopir' => $sopir1->id, 'id_admin' => $admin1->id, 'tanggal_booking' => '2021-01-12', 'tanggal_mulai' => '2021-01-13', 'tanggal_selesai' => '2021-01-18', 'tanggal_kembali' => '2021-01-18', 'denda' => '0', 'durasi' => '5 hari', 'status' => 'Sewa', 'jumlah_bayar' => '5000000', 'jumlah_dp' => '2000000']);
